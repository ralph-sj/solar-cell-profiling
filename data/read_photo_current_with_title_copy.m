...
filepath = '/Volumes/iMac Data/Documents/Dropbox/02 UNIVERSITY/02 Technical/07 Instrumentation/public/solar-cell-profiling/data/';
% solar_cell_name = 'IXYS KXOB22-12X1L';
solar_cell_name = 'CBC-PV-01N';
file =[solar_cell_name,'.dat'];
