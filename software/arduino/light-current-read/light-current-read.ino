...
void loop(void)
{
  ...
  float   multiplier = 0.03125F;    /* ADS1115 @ +/- 1.024V gain (16-bit results) */
  float   multiplier1 = 0.1875F;    /* ADS1115 @ +/- 1.024V gain (16-bit results) */
  ...
  Serial.print(",");
  Serial.println(results1 * multiplier1);
  delay(1000);
}
